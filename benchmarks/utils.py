...
class ResnetFE(torch.nn.Module):
...
class ZoomCAMResnet(torch.nn.Module):

 def __init__(self, resnet):
  super(ZoomCAMResnet, self).__init__()
  self.features = ResnetFE(resnet)
  self.avgpool = resnet.avgpool
...
imagenet_labels = {0: 'tench, Tinca tinca',
 ...
 478: 'carton',
 479: 'car wheel',
 480: 'cash machine, cash dispenser, automated teller machine, ATM',
 481: 'cassette',
 482: 'cassette player',
 483: 'castle',
 484: 'catamaran',
